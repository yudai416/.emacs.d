...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rust-common" '("rust-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rust-prog-mode" '("rust-")))
...
;;;***

;;;### (autoloads nil nil ("rust-mode-pkg.el" "rust-mode-treesitter.el")
;;;;;;  (0 0 0 0))
